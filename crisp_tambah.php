    ...
    <div class="col-sm-6">
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <select class="form-select" name="kode_kriteria"><?= get_kriteria_option(set_value('kode_kriteria')) ?></select>
            </div>
            <div class="mb-3">
                <label>Nama Subkriteria</label>
                <input class="form-control" type="text" name="nama_crisp" value="<?= set_value('nama_crisp') ?>" />
            </div>
            <div class="mb-3">
                <label>Nilai</label>
